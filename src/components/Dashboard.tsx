      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
        ...
        <div className="bg-white/5 rounded-3xl border border-white/10 p-6 space-y-6">
          <div className="space-y-4">
            <div className="flex items-center gap-2 text-[#ff4e00] font-bold uppercase text-xs">
              <Target className="w-4 h-4" />{t('emergingProfessions', language) || 'Emerging Horizons'}
            </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] sm:text-xs text-gray-400 leading-relaxed italic">
                        {selectedRoadmap.proTip || (language === 'Uzbek' ? "Insonlar bilan muloqot va ijodiy fikrlash bu yo'lda sizga eng katta yordamchi bo'ladi." : language === 'Turkish' ? "İletişim ve yaratıcı düşünme bu yolda size en büyük yardımcı olacaktır." : "Networking and creative thinking will be your best allies. Never stop learning.")}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex-1 overflow-y-auto">
                {isLoadingCareerInsight ? (
                  ...
                  <div className="p-6 sm:p-8 space-y-6">
                    <div className="space-y-2">
                      ...
                      <div className="flex flex-wrap gap-4 text-xs font-semibold uppercase tracking-wider text-gray-400">
                        <div className="flex items-center gap-1.5 bg-white/5 px-2.5 py-1 rounded-lg"><TrendingUp className="w-3.5 h-3.5 text-green-500" />{careerInsightData.demandLevel} Demand</div>
                  ...
                  <div className="h-64 flex flex-col items-center justify-center p-8 text-center text-gray-500">
                    <AlertTriangle className="w-10 h-10 mb-2 opacity-20" /><p>Information currently unavailable.</p>
                  </div>
                )}
              </div>
            </motion.div>
